...
// Create a custom event for triggering the contact popup
export const triggerContactPopup = () => {
    ...
    <section id="home" ref={ref} className="relative overflow-hidden pt-20 pb-12 sm:pt-24 sm:pb-16 lg:pt-32 lg:pb-24 bg-[#050816]">
      ...
      <div className="container-px grid items-start gap-12 lg:items-start lg:grid-cols-12">
        ...
        >
          ...
          >
            <button
              onClick={() => triggerContactPopup()}
              className="inline-flex h-14 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#6C63FF] to-[#00E5FF] px-8 text-base font-bold text-white shadow-lg shadow-[#6C63FF]/30 hover:shadow-[#6C63FF]/50 transition duration-200 text-center cursor-pointer"
            >
              Get Free Quote
            </button>
            ...
            <a
              ...
              className="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-[#6C63FF]/30 bg-[#050816]/80 backdrop-blur-sm px-4 text-xs font-bold text-white shadow-lg hover:bg-[#6C63FF]/20 transition duration-200 text-center"
            >
              <HiPhone className="h-4 w-4 text-[#00E5FF]" />
              Call Now
            </a>
            ...
            <a
              ...
              className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-4 text-xs font-bold text-white shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/50 transition duration-200 text-center"
            >
